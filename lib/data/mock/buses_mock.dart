...
const List<BusLine> allBusLines = [
  BusLine(
    ...
    stationIds: ['nassria', 'hached', 'centre_ville', 'bab_bhare'],
    startHour: 5,
    startMinute: 30,
    endHour: 22,
    endMinute: 0,
  ...
  BusLine(
    ...
    stationIds: ['sfax_sud', 'hay_riadh', 'universite'],
    startHour: 5,
    startMinute: 45,
    endHour: 21,
    endMinute: 30,
  ...
  BusLine(
    ...
    directionTo: 'Médina',
    stationIds: ['aeroport', 'route_tunis', 'centre_ville', 'medina'],
    startHour: 6,
    startMinute: 0,
    endHour: 21,
    endMinute: 0,
  ...
  BusLine(
    ...
    stationIds: ['sakiet_ezzit', 'soukra', 'gare_routiere'],
    startHour: 5,
    startMinute: 30,
    endHour: 22,
    endMinute: 0,
  ...
  BusLine(
    ...
    directionTo: 'Nassria',
    stationIds: ['chihia', 'sfax_ville', 'centre_ville', 'nassria'],
    startHour: 5,
    startMinute: 40,
    endHour: 21,
    endMinute: 40,
  ...
  BusLine(
    ...
    stationIds: ['hay_ennour', 'hay_wahat', 'place_municipale', 'centre_ville'],
    startHour: 6,
    startMinute: 0,
    endHour: 21,
    endMinute: 30,
