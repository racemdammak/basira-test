...
## 🎯 The Mission
In Sfax, taking the bus is a visual and physical challenge. Basira changes this by combining a highly accurate GPS simulation engine with Generative AI (Gemini) to provide:
...
* **Proactive AI Guide:** Gemini powered assistant that understands natural language queries and narrates complex multi-leg journeys.
...
* **AI:** Gemini (Gemini 1.5-flash) for real-time STT/TTS processing, Google Gemini for complex route narration.
